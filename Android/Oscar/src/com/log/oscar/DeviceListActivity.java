...
public class DeviceListActivity extends Activity {
	...
	public void onResume() {
		super.onResume();
		// It is best to check BT status at onResume in case something has
		// changed while app was paused etc
		checkBTState();

		mPairedDevicesArrayAdapter.clear();// clears the array so items aren't
											// duplicated when resuming from
											// onPause
	...
	private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
			...
			// is the MAC address.
			Intent rooms = new Intent(DeviceListActivity.this,
					Rooms.class);
			rooms.putExtra(EXTRA_DEVICE_ADDRESS, address);
			startActivity(rooms);
			
			
			//Intent openHome = new Intent("com.log.oscar.HOME");
